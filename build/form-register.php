...
if (count($form_errors)) {
    ...
    try {
        ...
        $mail_from = $email;
        $mail_subject = 'Cubegg registration form.';
        $mail_body = "User registration data: Name: <$name> Email: <$email> Password: <$password> ";
        ...
        print json_encode(array('result' => 'error', 'form_errors' => ['password' => 'Ошибка сервера']));
